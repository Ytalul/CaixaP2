...
public class ResultadoMegasena {
    ...
    private final static String URL = "\n" + "https://servicebus2.caixa.gov.br/portaldeloterias/api/loterias";

    /** Marcação inicial para extrair as dezenas do retorno HTML. */
    private final static String MARCA_INICIAL_RETORNO_NAO_UTIL = " \"dezenasSorteadasOrdemSorteio\": [";
    ...
    private static String[] obterDezenas(String html) {
        ...
        // Criação de array, com base no método split(), separando por hífen.
